...
class TestUsers:
    ...
    def test_register_user_success(self, client):
        ...
        assert json_response["username"] == self.username
    ...
    def test_create_superuser_failure_is_staff(self):
        with pytest.raises(ValueError, match = "Superuser must have is_staff=True."):
            User.objects.create_superuser(**self.credentials, **{"is_staff": False})

    def test_create_superuser_failure_is_superuser(self):
        with pytest.raises(ValueError, match = "Superuser must have is_superuser=True."):
            User.objects.create_superuser(**self.credentials, **{"is_superuser": False})
